...
COREIOT_SETSTATE_METHOD_2 = os.environ.get('COREIOT_SETSTATE_METHOD_2', 'setState2')
COREIOT_SETSTATE_VALUE_METHOD_2 = os.environ.get('COREIOT_SETSTATE_VALUE_METHOD_2', 'setValue2')
...
COREIOT_BRIGHTNESS_2_KEY = os.environ.get('COREIOT_BRIGHTNESS_2_KEY', 'brightness_2')
COREIOT_FAN_SPEED_2_KEY = os.environ.get('COREIOT_FAN_SPEED_2_KEY', 'fan_speed_2')
...
COREIOT_TELEMETRY_KEYS = [
    ...
    COREIOT_BRIGHTNESS_2_KEY,
    COREIOT_FAN_SPEED_2_KEY,
...
COREIOT_LOCAL_LIGHT_ACTUATOR_2_ID = os.environ.get('COREIOT_LOCAL_LIGHT_ACTUATOR_2_ID', '')
COREIOT_LOCAL_FAN_ACTUATOR_2_ID = os.environ.get('COREIOT_LOCAL_FAN_ACTUATOR_2_ID', '')
